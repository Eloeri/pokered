...
CeruleanPokecenter_Object:
	...
	object_event  6,  3, SPRITE_SUPER_NERD, STAY, DOWN, TEXT_CERULEANPOKECENTER_MOVE_DELETER
	object_event  7,  3, SPRITE_YOUNGSTER, STAY, DOWN, TEXT_CERULEANPOKECENTER_MOVE_RELEARNER
